...
import { Alert, Badge, Button, Card, CloseButton, Col, Dropdown, Form, InputGroup, ListGroup, Pagination, Row, Table } from 'react-bootstrap';
      ...
      },
      {
        ...
        Cell: (props) => (
          <>
            ...
            <a className="text-reset" href="/profile-posts">
              {props.value}
            </a>
          </>
        ),
      ...
      {Object.keys(selectedRowIds).length > 0 && (
        <Alert variant="dark" className="list-alert alert-dismissible border">
          <Row className="align-items-center">
            ...
            <Col xs="auto" className="me-n3">
              <Button variant={null} size="sm" className="bg-white text-white bg-opacity-20 bg-opacity-15-hover">
                Edit
              </Button>
              <Button variant={null} size="sm" className="bg-white text-white bg-opacity-20 bg-opacity-15-hover ms-1">
                Delete
              </Button>
            </Col>
          </Row>
