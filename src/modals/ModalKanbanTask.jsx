          ...
          <Row>
            ...
            <Col xs="auto" className="me-n3">
              <Avatar.Group className="d-none d-sm-flex">
                <Avatar  href="/profile-posts" size="xs">
            ...
            <ListGroup className="list-group-flush my-n3">
              <ListGroup.Item>
                <Row className="align-items-center">
                  <Col xs="auto">
                    <Avatar  href="/project-overview">
                      <Avatar.Image className="rounded" src="/img/files/file-1.jpg" alt="..." />
                    </Avatar>
                  </Col>
                  <Col className="ms-n2">
                    <h4 className="mb-1">
                      <a href="/project-overview">Launchday logo</a>
                    </h4>
                    <Card.Text className="small text-body-secondary">1.5mb PNG Dave</Card.Text>
                  </Col>
        ...
        <Card>
          ...
          <Card.Body>
            <Comment className="mb-3">
              <Row>
                <Col xs="auto">
                  <Avatar  href="/profile-posts" size="sm">
